					...
					<div class="col-md-12">					
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-10">
	      							<input type="text" name="urId" class="form-control" value='${login.urId }' readonly>
	    						</div>						
							</div>											
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
	      							 <textarea id="ly12-editor" name="brContent" class="form-control ly12-editor" rows="3" placeholder="내용을 입력해주세요"></textarea>
